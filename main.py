...
৬. লার্জার স্ট্রাকচার (Higher Timeframe) ওয়েব, সাব-ওয়েব। 
৭.বর্তমান স্ট্রাকচার (Current Position) ওয়েব, সাব-ওয়েব। 
     *সামনে,কখন,ওয়েব ও সাব-ওয়েব আসবে ডিটেইলস এনালিস্ট টেবিল days-month-year সহ টেবিল*
*impulse,কারেক্টিভ,up,down উল্লেখ করতে হবে*
* সাব-ওয়েব দেখতে হবে: wave 5 of 3 বা wave B of 4*
═══════════════════════════════════════════════════════════
...
【অ্যাকশন রিকমেন্ডেশন】
  ফ্যাক্টর ওয়েটেজ স্কোরিং মানদণ্ড
১. এলিয়ট ওয়েভ কনফার্মেশন ২০% ওয়েভ পজিশন সঠিক হলে ২০%, ভুল হলে ০%
২. ডাইভারজেন্স সিগন্যাল ২০% ডাবল ডাইভারজেন্স ২০%, সিঙ্গেল ১০%, নেই ০%
৩. চার্ট প্যাটার্ন কনফার্মেশন ১৫% ক্লাসিক প্যাটার্ন ১৫%, নন-ক্লাসিক ৭%, নেই ০%
৪. স্মার্ট মানি কনসেপ্টস ১৫% অর্ডার ব্লক+FVG ১৫%, শুধু একটিতে ৭%, নেই ০%
৫. সাপোর্ট-রেজিস্ট্যান্স ১০% মেজর লেভেলে অবস্থান ১০%, নিকটবর্তী ৫%, দূরে ০%
৬. ভলিউম কনফার্মেশন ১০% ব্রেকআউটে ভলিউম ১০%, ডাইভারজেন্সে ৫%, নেই ০%
৭. প্রাইস অ্যাকশন ১০% বুলিশ প্যাটার্ন ১০%, নিউট্রাল ৫%, বেয়ারিশ ০%
মোট ১০০% 

📈 কনফিডেন্স লেভেল ব্যাখ্যা

স্কোর রেঞ্জ কনফিডেন্স লেভেল অর্থ কি মনে রাখবেন
৯০-১০০% এক্সট্রিম হাই প্রায় নিশ্চিত ট্রেন্ড মুভমেন্ট সর্বোচ্চ পজিশন সাইজ নেওয়া যেতে পারে, তবে ১০০% নিশ্চিত কিছু নেই
৮০-৮৯% ভারি হাই খুব শক্তিশালী কনফ্লুয়েন্স বড় পজিশন নেওয়ার উপযুক্ত সময়, SL মানুন
৭০-৭৯% হাই ভালো কনফ্লুয়েন্স বিদ্যমান স্বাভাবিক পজিশন সাইজ, TP1 এ অংশ বুক করুন
৬০-৬৯% মডারেট হাই গ্রহণযোগ্য সেটআপ স্টেজড এন্ট্রি নিন, রিস্ক ম্যানেজমেন্ট কঠোর করুন
৫০-৫৯% নিউট্রাল স্পষ্ট দিকনির্দেশনা নেই অপেক্ষা করুন, ফোর্স করবেন না
৪০-৪৯% লো দুর্বল কনফ্লুয়েন্স নতুন পজিশন এড়িয়ে চলুন
০-৩৯% ভারি লো কোন কনফ্লুয়েন্স নেই বাই বন্ধ রাখুন, বিদ্যমান পজিশন রিভিউ করুন

---

⚙️ স্কোরিং এক্সাম্পল টেমপ্লেট (কিভাবে ব্যবহার করবেন)

বুলিশ সেটআপের জন্য:

ফ্যাক্টর ওয়েটেজ প্রাপ্ত স্কোর রেশনাল
এলিয়ট ওয়েভ ২০% ১৮ ওয়েভ ৪-এর শেষে, ৯০% কনফিডেন্স
ডাইভারজেন্স ২০% ১৮ ডাবল বুলিশ ডাইভারজেন্স
চার্ট প্যাটার্ন ১৫% ১৩ কাপ অ্যান্ড হ্যান্ডেল (হ্যান্ডেল পর্যায়)
স্মার্ট মানি ১৫% ১২ বুলিশ OB + FVG জোনে
সাপোর্ট-রেজিস্ট্যান্স ১০% ৮ মেজর সাপোর্ট জোনে (৮৫-৮৮)
ভলিউম ১০% ৭ ডাউনট্রেন্ডে ভলিউম কমেছে
প্রাইস অ্যাকশন ১০% ৮ ডজি + পিন বার সিগন্যাল
মোট ১০০% ৮৪ STRONG BUY

বেয়ারিশ সেটআপের জন্য (DSE-তে AVOID রেটিং):

ফ্যাক্টর ওয়েটেজ প্রাপ্ত স্কোর রেশনাল
এলিয়ট ওয়েভ ২০% ১৬ ওয়েভ ২ চলছে, আরও ডাউন সম্ভাবনা
ডাইভারজেন্স ২০% ১৬ হিডেন বেয়ারিশ ডাইভারজেন্স
চার্ট প্যাটার্ন ১৫% ১২ ডাবল টপ প্যাটার্ন কনফার্মড
স্মার্ট মানি ১৫% ১২ বেয়ারিশ OB সক্রিয়
সাপোর্ট-রেজিস্ট্যান্স ১০% ৮ মেজর রেজিস্ট্যান্সে রিজেক্ট
ভলিউম ১০% ৮ ডাউনমুভে ভলিউম স্পাইক
প্রাইস অ্যাকশন ১০% ৮ শুটিং স্টার + এনগালফিং
মোট ১০০% ৮০ STRONG AVOID

 [আউটপুট ফরম্যাট - বাংলায় উত্তর দিন]
 [কোনটা কত % হলে কি মনে করতে হবে তাও লিখা থাকবে]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
